...
Scene hw1_scene_5{
    ...
    std::vector<Sphere>{
        ...
        {Vector3{ 1.0,    0.0, -3.0},   0.5, 2},
        {Vector3{-1.0,    0.0, -3.0},   0.5, 3},
        {Vector3{ 1.0, -10.5, -2.0}, 100.0, 0},
        {Vector3{ 2.0,    1.0, -2.0},   0.5, 1},
        {Vector3{ -1.0,   -1.0, -1.0},   0.5, 2},
        {Vector3{1.0,    1.0, 0.0},   0.5, 3}
    },
    std::vector<Material>{
        {MaterialType::Mirror, Vector3{0.80, 0.80, 0.20}},
        {MaterialType::Mirror, Vector3{0.75, 0.25, 0.25}},
        {MaterialType::Mirror , Vector3{0.75, 0.25, 0.75}},
        {MaterialType::Mirror , Vector3{0.25, 0.75, 0.75}},
        {MaterialType::Mirror, Vector3{0.20, 0.50, 0.30}},
        {MaterialType::Mirror, Vector3{0.35, 0.45, 0.75}},
        {MaterialType::Mirror , Vector3{0.15, 0.95, 0.0}},
        {MaterialType::Mirror , Vector3{0.25, 0.2, 0.5}}
    },
    std::vector<PointLight>{
        {Vector3{1000, 1000, 1000}, Vector3{ 5, 5,  2}},
        {Vector3{ 10,  10,  10}, Vector3{-5, 5,  1}},
        {Vector3{  2,   2,   2}, Vector3{ 0, 5, -5}}
    }
};
